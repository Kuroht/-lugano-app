...
export default function ProductCard( { product, locale }: { product: any, locale : string } ) {
  ...
  return (
    isIngredient ? 
    <div className='flex flex-col border rounded-xl p-4 shadow-md bg-slate-900/90 border-transparent'>
        ...
        <div className="flex justify-center items-center h-48 sm:h-auto">
            ...
            alt={isIngredient && locale === "en" ? product.nameEn : product.name} 
        ...
        <div className="mt-4 flex flex-row justify-between">
            <h3 className="text-xl font-bold"><span className='mr-1'>{product.number}</span>{isIngredient && locale === "en" ? product.nameEn : product.name}}</h3>
